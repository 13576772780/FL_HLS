...
countries = ['c=4', 'c=6', 'c=8', 'c=9', 'c=10']
fedavg_medal = [83.53,	65.92,	65.54,	61.98,	55.46]
fedrep_medal = [82.47,	77.05,	76.79,	76.15,	75.56]
ditto_medal = [84.01,	71.12,	65.42,	65.69,	61.27]
scaffold_medal = [70.38,	67.55,	66.35,	65.25,	64.42]
fedpls_medal = [83.19,	79.56,	78.51,	78.04,	77.67]
x = np.array([0, 1.5, 3, 4.5, 6])
